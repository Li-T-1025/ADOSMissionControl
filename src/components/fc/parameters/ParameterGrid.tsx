                  ...
                  {vis.name && (
                    <div className={cn("px-3 font-mono truncate", differsFromDefault && !isModified ? "text-accent-primary" : "text-text-primary")}>
                      <div className="flex items-center gap-1">
                        <ParamTooltip meta={meta} docUrl={getParamDocUrlFromContext(param.name, docContext)} docsLinkLabel={docsLinkLabel}><span className="cursor-default">{param.name}</span></ParamTooltip>
